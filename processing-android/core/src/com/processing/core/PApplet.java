...
import com.processing.data.*;
import com.processing.event.*;
import com.processing.opengl.*;
...
//        if (objects[i] == object && methods[i].equals(method)) {
  ...
  public void registerMethod(String methodName, Object target) {
    if (methodName.equals("mouseEvent")) {
      registerWithArgs("mouseEvent", target, new Class[] { com.processing.event.MouseEvent.class });

    } else if (methodName.equals("keyEvent")) {
      registerWithArgs("keyEvent", target, new Class[] { com.processing.event.KeyEvent.class });

    } else if (methodName.equals("touchEvent")) {
      registerWithArgs("touchEvent", target, new Class[] { com.processing.event.TouchEvent.class });
...
//  }
   ...
   */
  public void postEvent(com.processing.event.Event pe) {
    eventQueue.add(pe);
...
//  }
   ...
   * @see com.processing.core.PImage#blendColor(int,int,int)
   */
